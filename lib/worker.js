(function() {
  ...
  fetch_url = function(url, response, this_inst, parse_delay, request_headers, get_requests, get_cookies) {
    var cookie_inst, done, final_url, had_js_errors, headers, page_inst, redirects, requests;
    final_url = url;
    headers = {};
    requests = [];
    redirects = [];
    ...
    page_inst.onNavigationRequested = function(targetUrl, type, willNavigate, main) {
      if (targetUrl === !url && targetUrl === !'about:blank' && willNavigate === true && main === true) {
